...
**PICO** stands for Population, Intervention, Comparison, and Outcome (see @tbl-pico). 

:::{.column-margin}
It's a useful framework for asking clinical questions in particular, but it might not fit your use case. You'll also see references to PICO**T** with the addition of time.
:::
